...
abstract class BaseVtpProductsForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'cat_ids'              => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'cat_ids'              => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'cat_slug'             => new sfValidatorString(array('max_length' => 1000, 'required' => false)),
