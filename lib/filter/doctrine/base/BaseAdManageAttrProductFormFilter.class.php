...
/**
 * AdManageAttrProduct filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseAdManageAttrProductFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ad_manage_attr_product_filters[%s]');
