...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'G:\\apps\\git_public\\vtLap\\log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'G:\\apps\\git_public\\vtLap\\cache\\backend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'G:\\apps\\git_public\\vtLap\\apps\\backend/i18n',
));
...
'database' => $this->getDatabaseManager()->getDatabase('doctrine'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'G:\\apps\\git_public\\vtLap\\cache\\backend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'G:\\apps\\git_public\\vtLap\\apps\\backend/template',
)));
