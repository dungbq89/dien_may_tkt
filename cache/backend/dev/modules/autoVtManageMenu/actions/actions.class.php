...
require_once(dirname(__FILE__).'/../lib/BaseVtManageMenuGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseVtManageMenuGeneratorHelper.class.php');
 ...
 */
abstract class autoVtManageMenuActions extends sfActions
{
  /**
  ...
  public function executeToggleBoolean(sfWebRequest $request)
  {
    ...
    $table = Doctrine_Core::getTable('VtpMenu');
  ...
  {
    $this->configuration = new vtManageMenuGeneratorConfiguration();
    ...
    $this->helper = new vtManageMenuGeneratorHelper();
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->vtp_menu = $this->form->getObject();
  }
  ...
  public function executeEdit(sfWebRequest $request)
  {
    ...
    $this->vtp_menu = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->vtp_menu);
    $this->fields = $this->vtp_menu->getTable()->getColumnNames();
  }
    ...
    public function executeRevert(sfWebRequest $request)
    {
        ...
        $redirect = $request->getReferer() ? $request->getReferer() : array('sf_route' => 'vtp_menu_show', 'sf_subject' => $object);
  ...
  {
    return $this->getUser()->getAttribute('vtManageMenu.filters', $this->configuration->getFilterDefaults(), 'admin_module');
  }

  protected function setFilters(array $filters)
  {
    return $this->getUser()->setAttribute('vtManageMenu.filters', $filters, 'admin_module');
  }
  ...
  protected function getPager()
  {
    ...
    $pager = $this->configuration->getPager('VtpMenu');
  ...
  {
    $this->getUser()->setAttribute('vtManageMenu.max_per_page', (integer) $max_per_page, 'admin_module');
  }
  
  protected function getMaxPerPage()
  {
    return $this->getUser()->getAttribute('vtManageMenu.max_per_page', sfConfig::get('app_default_max_per_page', 20), 'admin_module');
  }

  protected function setPage($page)
  {
    $this->getUser()->setAttribute('vtManageMenu.page', $page, 'admin_module');
  }

  protected function getPage()
  {
    return $this->getUser()->getAttribute('vtManageMenu.page', 1, 'admin_module');
  }
  ...
  {
    if (null !== $sort = $this->getUser()->getAttribute('vtManageMenu.sort', null, 'admin_module'))
    {
      return $sort;
    }
    ...
    return $this->getUser()->getAttribute('vtManageMenu.sort', null, 'admin_module');
  }
  ...
  protected function setSort(array $sort)
  {
    ...
    $this->getUser()->setAttribute('vtManageMenu.sort', $sort, 'admin_module');
  }

  protected function isValidSortColumn($column)
  {
    return Doctrine_Core::getTable('VtpMenu')->hasColumn($column);
  }
