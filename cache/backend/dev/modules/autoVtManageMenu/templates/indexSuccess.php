...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
            ...
            <div class="row-fluid">
                <div class="span9">
                                  <?php include_partial('vtManageMenu/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
                                </div>
                <div class="span3">
                    <div class="pull-right"><?php include_partial('vtManageMenu/list_actions', array('helper' => $helper)) ?></div>
                </div>
            </div>
            ...
            <div id="sf_admin_header">
                <?php include_partial('vtManageMenu/list_header', array('pager' => $pager)) ?>
            </div>

            <div id="sf_admin_content">
                                    <form class="form-inline" id="list-form" action="<?php echo url_for('vtp_menu_collection', array('action' => 'batch')) ?>" method="post">
                
                <?php include_partial('vtManageMenu/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>

                <div>
                    <?php include_partial('vtManageMenu/list_batch_actions', array('helper' => $helper)) ?>
                </div>
                                    </form>
                
                <form class="form-inline" method="get" action="<?php echo url_for('vtp_menu') ?>">
                    <div class="well pull-right">
                      <?php echo __('Số bản ghi/trang: ')?>
                        <?php $select = new sfWidgetFormChoice(array(
                                    ...
                                    array('class' => 'input-medium')); echo $select->render('max_per_page', $sf_user->getAttribute('vtManageMenu.max_per_page', null, 'admin_module')) ?>
            ...
            <?php include_partial('vtManageMenu/list_footer', array('pager' => $pager)) ?>
        </div>
    </div>
</div>
