...
<div class="container-fluid">
    <div class="row-fluid">
        <?php if ($sidebar_status): ?>
            <?php include_partial('vtpManageProductsCategory/edit_sidebar', array('configuration' => $configuration, 'vtp_products_category' => $vtp_products_category)) ?>
        <?php endif; ?>

        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
            <h1><?php echo __('Sửa chuyên mục sản phẩm', array(), 'messages') ?></h1>
