 ...
 * @author ngoctv1
 */
class AdArticleFormAdmin extends BaseAdArticleForm
{
    public function configure()
    {
        ...
        $arrCat = $this->getParentByType();
        $this->setWidgets(array(
            'id' => new sfWidgetFormInputHidden(),
            'lang' => new sfWidgetFormInputHidden([], ['value' => sfContext::getInstance()->getUser()->getCulture()]),
...
//            var_dump($arrCat);
//            var_dump($arrCatIds);
//            $this->setDefault('cat_ids', $arrCatIds);
//        }
