...
<?php
              ...
              "contain": true
                            ...
                            <div class="product-info summary entry-summary col col-fit product-summary form-flat">
                                ...
                                <!--                                                class="screen-reader-text" for="">Số lượng</label>-->
                                <!--                                        <input-->
                                <!--                                                type="number"-->
                                <!--                                                id=""-->
                                ...
                                <!---->
                                <!--                                    <button type="submit" name="add-to-cart" value="1618"-->
                                    ...
                                    <div class='popup-inner'>
                                        <div id='contact_form_pop'>
                                            ...
                                            <div class='form-content'>
                                                <div class='cottrai'>
                                                    <img src="https://laptop91.com/wp-content/uploads/2020/07/z1985308445880_91120cbdb752ff6d04d860b03595d311.jpg">
                                                    <div class='title-wrapper'>Dell 3568 i5 7200 ram 8gb ssssd 128gb
                                                        +hdd 1tb vừa rời 2gb mấy như đập hộp.
                                                    </div>
                                                    <del><span
                                                                class="woocommerce-Price-amount amount">11.700.000<span
                                                    ...
                                                    <div class="review-form-inner has-border">
                                                        <div id="respond" class="comment-respond">
                                                            <h3 id="reply-title" class="comment-reply-title">Hãy là
                                                                người đầu tiên nhận xét &ldquo;Dell 3568 i5 7200 ram
                                                                8gb ssssd 128gb +hdd 1tb vừa rời 2gb mấy như đập
                                                                hộp. &rdquo; <small><a rel="nofollow"
                                                                                       id="cancel-comment-reply-link"
                                                                                       href="/s%E1%BA%A3n%20ph%E1%BA%A9m/dell-3568-i5-7200-ram-8gb-ssssd-128gb-hdd-1tb-vua-roi-2gb-may-nhu-dap-hop/#respond"
                                                                                       style="display:none;">Hủy</a></small>
                                                            </h3>
                                                            <form action="https://laptop91.com/wp-comments-post.php"
                                                                ...
                                                                <p class="comment-form-cookies-consent"><input
                                                                        ...
                                                                        tôi, email, và trang web trong trình duyệt này
                                                                        cho lần bình luận kế tiếp của tôi.</label></p>
